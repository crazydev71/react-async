...
var ReactCompositeComponentMixin = {
  ...
  performInitialMount: async function(renderedElement, hostParent, hostContainerInfo, transaction, context) {
    ...
    if (renderedElement === undefined) {
        renderedElement = await this._renderValidatedComponent();
    }
   ...
   * @protected
   */
  _renderValidatedComponentWithoutOwnerOrContext: async function() {
    var inst = this._instance;
   ...
   */
   ...
   //  return 2;
   // },
   // _sample: async function() {
   //    var result = await this._test();
   //    console.log(result);
   // },
   // _foo: async function() {
   //    console.log('noise', this);
   //  },
  _renderValidatedComponent: async function() {
    var renderedComponent;
    
    if (__DEV__ || this._compositeType !== CompositeTypes.StatelessFunctional) {
      ReactCurrentOwner.current = this;
      try {
        renderedComponent = await this._renderValidatedComponentWithoutOwnerOrContext();
      } finally {
        ReactCurrentOwner.current = null;
      }
    } else {
